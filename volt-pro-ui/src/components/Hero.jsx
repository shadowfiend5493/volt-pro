...
const Hero = () => {
    return (
        <section className="hero-bg relative h-[calc(100vh-64px)] min-h-150 flex flex-col justify-start overflow-hidden max-md:h-auto max-md:min-h-svh">
            ...
            <div className="relative z-2 pt-20 pb-8 px-[clamp(1.5rem,5vw,7rem)] shrink-0">
                <div className="max-w-130">
                    ...
                    <p className="text-[1.1rem] leading-7 text-volt-muted max-w-130 mb-10 mt-0">
